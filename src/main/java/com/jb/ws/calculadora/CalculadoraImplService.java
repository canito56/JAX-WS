 ...
 * 
 */
@WebServiceClient(name = "CalculadoraImplService", targetNamespace = "http://calculadora.ws.jb.com/", wsdlLocation = "http://localhost:8080/WS/Calculadora?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULADORAIMPLSERVICE_QNAME = new QName("http://calculadora.ws.jb.com/", "CalculadoraImplService");
    ...
    public ICalculadora getCalculadoraImplPort() {
        return super.getPort(new QName("http://calculadora.ws.jb.com/", "CalculadoraImplPort"), ICalculadora.class);
    }
    ...
    public ICalculadora getCalculadoraImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calculadora.ws.jb.com/", "CalculadoraImplPort"), ICalculadora.class, features);
    }
